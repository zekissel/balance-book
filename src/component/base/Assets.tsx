	...
	return (
		<div className="page-root">
			<menu className="dynamic-menu">
				...
				<div className="dynamic-menu-main">
					<button onClick={() => setShowAddAccount(AccountType.Checking)}>
			...
			<AccountPage
				user={user}
				accounts={matchAccounts(curView)}
				updateAccounts={signalRefresh}
				transactions={transactions}
				type={curView}
				addAccount={setShowAddAccount}
			/>
			...
			{showAddAccount && (
				<CreateAccount
					user={user}
					type={showAddAccount}
					toggle={() => setShowAddAccount(null)}
					update={signalRefresh}
					setAddAccount={setShowAddAccount}
				/>
			)}
		</div>
	)
