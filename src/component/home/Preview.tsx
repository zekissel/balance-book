    ...
    <div className='home-preview'>
      ...
      <div>
        ...
        <menu>
          ...
          <input type='radio' name='home-account' id='loan' defaultChecked={curView === AccountType.Loan} onChange={() => handleRadio(AccountType.Loan)} /><label htmlFor="loan">Loan</label>
        </menu>
      </div>
